...
if (fs.existsSync(existingDbPath)) {
    ...
    const trendsCat = existing.categories.find(c => c.id === 'trends' || c.id === 'trend');
    if (trendsCat && trendsCat.subcategories) {
        trendsData = trendsCat.subcategories;
    }
}
...
const finalData = {
    ...
    metadata: {
        totalTopics: 500,
        lastUpdated: "2026-03-09T16:20:00+09:00",
        version: "2.0"
    }
};
